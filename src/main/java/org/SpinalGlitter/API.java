...
public class API {
    private static final String BASE = "GET https://www.elprisetjustnu.se/api/v1/prices";
    ...
    private final ObjectMapper mapper = new ObjectMapper().registerModule(new JavaTimeModule());
         ...
         public List<PriceEntry> fetchDay(LocalDate date, String zone) throws IOException, InterruptedException {
             ...
             String url = String.format("%s/%d/%s%_%s.json",
                     BASE, date.getYear(),
             ...
             return mapper.readValue(res.body(), new TypeReference<List<PriceEntry>>() {});
