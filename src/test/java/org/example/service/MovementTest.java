...
public class MovementTest {
    ...
    private void ensureClearCross(int x, int y) {
        dungeon.setTile(y, x, Tile.FLOOR.getTile());
        dungeon.setTile(y - 1, x, Tile.FLOOR.getTile());
        dungeon.setTile(y + 1, x, Tile.FLOOR.getTile());
        dungeon.setTile(y, x - 1, Tile.FLOOR.getTile());
        dungeon.setTile(y, x + 1, Tile.FLOOR.getTile());
    }
