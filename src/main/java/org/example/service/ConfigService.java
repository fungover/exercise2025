...
public class ConfigService {
    ...
    public DungeonGrid chooseMapSize(int choice) {
        switch (choice) {
            case 1:
                return DungeonGrid.createDungeonGrid(10, 10);
            case 2:
                return DungeonGrid.createDungeonGrid(15, 15);
            case 3:
                return DungeonGrid.createDungeonGrid(20, 20);
            default:
                return null;
        }
    }
