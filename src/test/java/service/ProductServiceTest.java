...
class ProductServiceTest {
    ...
    void addNewProduct_ValidParameters_Success() {
        productService.addNewProduct("CONV001", "Convenience Product", Category.BOOKS, 7, 400.0);
        ...
        assertEquals(400.0, retrievedProduct.get().price());
        assertFalse(retrievedProduct.get().isModified());
    }
    ...
    void updateProduct_ExistingProduct_Success() {
        ...
        productService.updateProduct("1", "iPhone 15 Pro", Category.ELECTRONICS, 10, 13000.0);
        ...
        assertEquals(13000.0, updated.get().price());
        assertTrue(updated.get().isModified());
    }
    ...
    void updateProduct_NonExistingProduct_ThrowsException() {
        IllegalArgumentException exception = assertThrows(
                IllegalArgumentException.class,
                () -> productService.updateProduct("999", "New Name", Category.BOOKS, 5, 500.0)
        );
    ...
    void getProductsByCategorySorted_MultipleProducts_ReturnsSortedByName() {
        ...
        assertEquals("Apple Toy", toysProducts.get(0).name());
    ...
    void getModifiedProducts_MixOfModifiedAndUnmodified_ReturnsOnlyModified() {
        ...
        productService.updateProduct("1", "Modified iPhone", Category.ELECTRONICS, 10, 13000.0);
    ...
    void getCategoriesWithProducts_MultipleCategories_ReturnsAllRepresentedCategories() {
        Product electronics1 = new Product.Builder()
                .id("2").name("iPhone").category(Category.ELECTRONICS).rating(9).price(12000.0).asNewProduct().build();
        Product electronics2 = new Product.Builder()
                .id("3").name("iPad").category(Category.ELECTRONICS).rating(8).price(8000.0).asNewProduct().build();
        Product clothing = new Product.Builder()
                .id("4").name("Jeans").category(Category.CLOTHING).rating(7).price(800.0).asNewProduct().build();
        Product books = new Product.Builder()
                .id("5").name("Java Book").category(Category.BOOKS).rating(9).price(500.0).asNewProduct().build();
        ...
        assertFalse(categories.contains(Category.FOOD));
    }
    ...
    void countProductsInCategory_MultipleProductsInCategory_ReturnsCorrectCount() {
        ...
        Product electronics3 = new Product.Builder()
                .id("4").name("MacBook").category(Category.ELECTRONICS).rating(10).price(15000.0).asNewProduct().build();
        Product clothing = new Product.Builder()
                .id("5").name("Jeans").category(Category.CLOTHING).rating(7).price(800.0).asNewProduct().build();
    ...
    void getProductInitialsMap_MultipleProducts_ReturnsCorrectInitialsCount() {
        ...
        Product android = new Product.Builder()
                .id("4").name("Android Phone").category(Category.ELECTRONICS).rating(7).price(7000.0).asNewProduct().build();
        Product book = new Product.Builder()
                .id("5").name("Book").category(Category.BOOKS).rating(6).price(300.0).asNewProduct().build();
        Product apple = new Product.Builder()
                .id("6").name("Apple Watch").category(Category.ELECTRONICS).rating(8).price(5000.0).asNewProduct().build();
        ...
        assertEquals(Integer.valueOf(2), initialsMap.get('I'));
        assertEquals(Integer.valueOf(2), initialsMap.get('A'));
        assertEquals(Integer.valueOf(1), initialsMap.get('B'));
        assertNull(initialsMap.get('C'));
    }
    ...
    void getProductInitialsMap_MixedCase_GroupsCorrectly() {
        Product apple1 = new Product.Builder()
                .id("2").name("apple").category(Category.FOOD).rating(5).price(10.0).asNewProduct().build();
        Product apple2 = new Product.Builder()
                .id("3").name("Apple Watch").category(Category.ELECTRONICS).rating(8).price(5000.0).asNewProduct().build();
    ...
    void getTopRatedProductsThisMonth_WithVariousRatings_ReturnsTopRatedNewestFirst() {
        ...
        Product product1 = new Product.Builder()
                .id("2").name("iPhone").category(Category.ELECTRONICS).rating(9).price(12000.0)
                .createdDate(startOfMonth).modifiedDate(startOfMonth).build();
        Product product2 = new Product.Builder()
                .id("3").name("iPad").category(Category.ELECTRONICS).rating(10).price(8000.0)
                .createdDate(midMonth).modifiedDate(midMonth).build();
        Product product3 = new Product.Builder()
                .id("4").name("MacBook").category(Category.ELECTRONICS).rating(8).price(15000.0)
                .createdDate(midMonth.plusDays(1)).modifiedDate(midMonth.plusDays(1)).build();
        Product product4 = new Product.Builder()
                .id("5").name("AirPods").category(Category.ELECTRONICS).rating(10).price(3000.0)
                .createdDate(endOfMonth).modifiedDate(endOfMonth).build();
        Product oldProduct = new Product.Builder()
                .id("6").name("Old Phone").category(Category.ELECTRONICS).rating(10).price(10000.0)
        ...
        assertEquals("AirPods", topProducts.get(0).name());
        assertEquals("iPad", topProducts.get(1).name());
    ...
    void getHighQualityProducts_WithThreshold_ReturnsFilteredProducts() {
        Product highQuality1 = new Product.Builder()
                .id("HQ1").name("Premium Product").category(Category.ELECTRONICS).rating(9).price(10000.0).asNewProduct().build();
        Product highQuality2 = new Product.Builder()
                .id("HQ2").name("Excellent Product").category(Category.BOOKS).rating(10).price(500.0).asNewProduct().build();
        Product lowQuality = new Product.Builder()
                .id("LQ1").name("Basic Product").category(Category.TOYS).rating(6).price(100.0).asNewProduct().build();
        ...
        assertEquals("Excellent Product", highQualityProducts.get(0).name());
        assertEquals("Premium Product", highQualityProducts.get(1).name());
    }
    ...
    void hasProductsInCategory_WithAndWithoutProducts_ReturnsCorrectBoolean() {
        Product electronics = new Product.Builder()
                .id("E1").name("Laptop").category(Category.ELECTRONICS).rating(8).price(10000.0).asNewProduct().build();
